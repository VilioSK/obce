<footer class="row">
                <div class="col mb-3">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col mb-12">
                                <ul>
                                    ...
                                    <li>
                                        <a href="https://www.sukl.sk/hlavna-stranka/slovenska-verzia/o-nas/kontakt/adresa?page_id=282">Adresa</a>
                                    </li>
                                    <li>
                        ...
                        <div class="row">
                            <div class="col mb-12">
                                <div class="footer-heading"> Informácie pre verejnosť </div>
                                <ul>
                                    <li>
                ...
                <div class="col mb-3">
                    <div class="container">
                        <div class="row">
                            <div class="col mb-12">
                                <div class="footer-heading"> Média </div>
                                <ul>
                                    <li>
                        ...
                        <div class="row">
                            <div class="col mb-12">
                                <div class="footer-heading"> Databázy a servis </div>
                                <ul>
                                    <li>
                ...
                <div class="col mb-3">
                    <div class="container">
                        <div class="row">
                            <div class="col mb-12">                           
                                <div class="footer-heading"> Drogové prekurzory </div>
                                <ul>
                                    <li>
                        ...
                        <div class="row">
                            <div class="col mb-12">                           
                                <div class="footer-heading"> Iné </div>
                                <ul>
                                    <li>
                        ...
                        <div class="row">
                            <div class="col mb-12 text-special">                           
                                <div class="footer-heading"> Rapid alert system </div>
                                <ul>
                                    <li>
